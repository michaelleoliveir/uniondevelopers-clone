            ...
            <div className="pt-[60px] lg:pt-[230px]">
                <div className="flex flex-col lg:flex-row">
                    <div className="text-left ml-[1rem] lg:ml-[2rem] max-w-[40rem] lg:pt-[70px] lg:mr-[190px] mr-[100px]">
                        <h1 className="mb-4 text-2xl font-bold text-white lg:leading-relaxed lg:text-5xl">
                        ...
                        <button onClick={() => handleScrollToSection("junte")} className="bg-gradient-to-r from-purple-600 to-blue-500 text-white px-[75px] lg:px-14 py-5 rounded-lg font-bold text-[1.5rem] lg:text-2xl whitespace-nowrap align-center">
                            Quero participar
                        </button>
                    </div>
                    {/* imagem (tela grande) */}
