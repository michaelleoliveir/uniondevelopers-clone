        ...
        <div id='beneficio' className="mx-auto flex items-center justify-center mt-[90px] w-auto">
            <div className="relative flex items-center justify-center w-full h-full p-6 bg-fundo rounded-2xl pb-9 font-poppins">
                ...
                <div className="flex flex-col">
                    ...
                    <Item img="https://media.graphassets.com/tsqge8g9TpyED5o5iVr6" titulo="Aprendizado de novas tecnologias e ferramentas" texto="Os membros são expostos a uma variedade de tecnologias e ferramentas relevantes, expandindo suas habilidades e conhecimentos." reverse={true} />
                    ...
                    <Item img="https://media.graphassets.com/eBMuKBvTLulsEbZySGwt" titulo="Desenvolvimento de soft skills" texto="Além das competências técnicas, os membros aprimoram habilidades interpessoais cruciais, como comunicação eficaz, resolução de conflitos e trabalho em equipe." reverse={true} />
                    ...
                    <Item img="https://media.graphassets.com/WR1yF2qGRmm8jWLCyw0D" titulo="Networking " texto="A participação no Union expande sua rede de contatos, abrindo portas para colaborações futuras e oportunidades profissionais." reverse={true} />
                    ...
                    <Item img="https://media.graphassets.com/sanArFzbQUipTnjRVl78" titulo="Mentoria" texto="Os mentores experientes oferecem orientação valiosa, proporcionando uma trajetória de aprendizado mais suave e eficiente." reverse={true} />
                </div>
            </div>
        </div>
    );
